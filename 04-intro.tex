...
all keys in memory is prohibitively expensive for large databases, creating the
very storage overhead that undermines timestamp-based protocols.
...
However, storing approximate timestamps creates an inherent compromise between
...
committed transactions (shown in \Cref{fig:sketch_size}).
