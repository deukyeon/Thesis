...
proceed or must abort to maintain serializability. This means that timestamps
cannot be discarded simply because no transaction is currently accessing a key,
as future transactions will need this information to make correct concurrency
control decisions. However, maintaining exact timestamps for all keys in memory
is prohibitively expensive for large databases, creating the very storage
overhead that undermines timestamp-based protocols.
