...
\section{Analytical Study of the \sketchname Approach Across the Storage Spectrum}
...
\begin{description}[leftmargin=2.5em, labelindent=0em, style=nextline]
    ...
    \item[Chapter 4: Analytical Study of the \sketchname Approach Across the Storage Spectrum]
