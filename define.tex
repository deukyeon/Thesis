...
\makeatother
\newlength{\ifwidth}
\settowidth{\ifwidth}{\algorithmicif\ }
\algdef{SE}[parIF]{parIf}{EndparIf}[1]
  {\parbox[t]{\dimexpr\linewidth-\algmargin}{%
     \hangindent\ifwidth\strut\algorithmicif\ #1\ \algorithmicthen\strut}}{\algorithmicend\ \algorithmicif}
\algdef{Ce}[parELSE]{parIF}{parElse}{EndparIf}{\algorithmicelse}
